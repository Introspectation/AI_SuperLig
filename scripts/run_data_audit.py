...
def generate_data_contract(evidence: dict[str, pd.DataFrame]) -> str:
    field_rows: list[list[Any]] = [
        ...
        [
            ...
            "REQUIRED",
            "time",
            "Time / reviewed TFF backfill",
            "Time is interpreted as UK clock after TFF cross-checks; TFF supplies two missing seasons.",
        ],
        [
            "kickoff_timezone",
            "REQUIRED",
            "string",
            "derived",
            "Europe/Istanbul after timezone-aware conversion.",
        ],
        [
            "kickoff_time_source",
            "REQUIRED",
            "enum",
            "derived lineage",
            "football_data_europe_london_converted or tff_archive.",
        ],
        [
            "result_available_at",
            "REQUIRED FOR ELIGIBLE",
            "nullable timezone-aware datetime",
            "derived / reviewed override",
            "Kickoff or reviewed resumption anchor plus the fixed 180-minute safety lag.",
        ],
        [
            ...
            "enum",
            "derived lineage",
            "Standard 180-minute lag, reviewed resumption lag, or not_model_eligible.",
        ],
        ...
        [
            ...
            "OPTIONAL",
            "nullable integer",
            "reviewed TFF decision",
            "Only populated when an official award differs from the on-pitch score.",
        ],
        [
            "official_away_goals",
            "OPTIONAL",
        ...
        [
            ...
            "OPTIONAL",
            "nullable enum H/D/A",
            "derived from official goals",
            "Kept separate from the on-pitch score-model target.",
        ],
        [
            "match_status",
            "REQUIRED",
            "enum",
            "curation/default",
            "played, not_played_forfeit, abandoned_forfeit, or played_then_awarded_forfeit.",
        ],
        [
            "model_eligible",
            "REQUIRED",
        ...
        [
            ...
            "Present for the two kickoff-backfilled seasons.",
        ],
    ]
    optional_fields = [
        ("home_ht_goals", "HTHG"),
        ...
        md_table(
            ...
            [
                ...
                [
                    ...
                    "REQUIRED",
                    "enum",
                    "primary_market_average or secondary_single_bookmaker.",
                ],
                [
                    "benchmark_regime",
                    "REQUIRED",
                    "enum",
                    "market_average_closing or pinnacle_closing.",
                ],
    ...
    lines = [
        ...
        md_table(
            ...
            [
                ...
                [
                    "Medium",
                    "Raw-source kickoff gap",
                    "`Time` absent in 2017-18/2018-19; later values align to the UK clock.",
                    "Raw-only processing cannot strictly order same-day fixtures in Turkish local time.",
                    "Backfill from TFF and convert Europe/London to Europe/Istanbul; retain simultaneous fallback.",
                ],
                [
                    "Medium",
